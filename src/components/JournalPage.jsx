          ...
          <Modal.Body id="journalModal">
            ...
            <div class="editJournalEntry">
                <form onSubmit={editJournalEntry}>
                  ...
                  <input type="text" placeholder={journalEntry.title} value={journalEntry.title} id={journalEntry._id} className="formInput" onChange={(e) => {setTitle(e.target.value)}}></input>
                  <label for="entry" className="formLabel">Edit Entry:</label>
                  <input type="text" className="formInput" placeholder={journalEntry.entry} value={journalEntry.entry} ></input>
